...
const chronicleSections = [
  ...
  {
    id: "beginner-papers",
    title: "AI / BCI / Embodied AI 入门路线",
    description: "先搭 AI 与神经计算骨架，再进入脑机接口和具身智能；资料不限论文，也包括课程、视频和工具。",
    items: [
      {
        id: "neuromatch-computational-neuroscience",
        ...
        region: "入门",
        topic: "Course · 神经计算",
        keywords: ["computational neuroscience", "neural coding", "dynamics", "Python"],
        importance: "critical",
        evidence: "course",
        result: "用交互式教程学习神经编码、动力系统、决策、贝叶斯模型和神经数据分析。",
        significance: "这是 BCI PhD 很好的底座：你会知道神经信号不是只拿来分类，而是有动力学、编码和行为意义。",
        commentary: "适合边学边跑 notebook，不要只看文字。",
        impact: "先完成神经编码、动力系统和贝叶斯部分，再回来看 BCI 解码论文会顺很多。"
      },
      {
        ...
        significance: "BCI 和具身智能都会越来越多地借用序列建模、多模态 token 和 attention 结构。",
        commentary: "这篇是 AI 入门必读中的必读，社会上关于大模型的讨论大多都间接建立在 Transformer 之上。",
        impact: "理解它会直接帮助你读 LLM、视觉语言模型、智能体和代码模型。"
      },
      {
        id: "stanford-cs229-youtube",
        title: "Stanford CS229 Machine Learning Lectures",
        source: "Stanford Online / YouTube",
        date: "Video",
        url: "https://www.youtube.com/playlist?list=PLoROMvodv4rMiGQp3WXShtMGgzqpfVfbU",
        region: "入门",
        topic: "Video · AI 基础",
        keywords: ["machine learning", "supervised learning", "classification", "optimization"],
        importance: "high",
        evidence: "course",
        result: "用系统视频课补机器学习基本盘：分类、回归、优化、泛化和概率模型。",
        significance: "BCI 解码本质上绕不开机器学习基本问题：数据少、噪声大、跨天漂移、泛化困难。",
        commentary: "建议先看监督学习、正则化和概率模型，不必一开始全刷完。",
        impact: "能帮助你判断一篇 BCI 论文的模型结果是不是扎实，而不是只看 accuracy。"
      },
      {
      ...
      {
        id: "rajesh-rao-bci-introduction",
        title: "Brain-Computer Interfacing: An Introduction",
        source: "Rajesh P. N. Rao",
        date: "Book",
        url: "https://www.cambridge.org/core/books/braincomputer-interfacing/FE3CCFA5A4C79BCDA2357A0E7B1F442D",
        region: "入门",
        topic: "Book · BCI",
        keywords: ["brain-computer interface", "neural decoding", "signal processing", "closed loop"],
        importance: "critical",
        evidence: "book",
        result: "从信号采集、特征提取、分类、反馈和应用场景建立 BCI 全局图谱。",
        significance: "这类入门书比碎片论文更适合第一轮搭框架，能帮你知道 BCI 的基本问题和术语。",
        commentary: "读的时候重点关注输入信号、解码目标、反馈方式和评价指标。",
        impact: "适合作为你和导师/师兄师姐讨论 BCI 方向前的共同语言。"
      },
      {
        id: "openbci-docs",
        ...
        region: "入门",
        topic: "Tool · BCI",
        keywords: ["EEG", "hardware", "OpenBCI", "signal acquisition"],
        importance: "high",
        evidence: "tool",
        result: "官方文档覆盖 EEG/EMG/ECG 采集、硬件连接、软件工具和基础实验流程。",
        significance: "它能让你把“脑机接口”从抽象论文落到真实信号、噪声、接触阻抗和采集流程。",
        commentary: "即使不用 OpenBCI 硬件，也值得看它如何组织实验和数据流。",
        impact: "适合做一个小 demo：采集/模拟 EEG，完成滤波、特征提取和分类。"
      },
      {
        id: "bci-bilibili-search",
        title: "Bilibili: 脑机接口 入门 / EEG 信号处理",
        source: "Bilibili 检索入口",
        date: "Video",
        url: "https://search.bilibili.com/all?keyword=%E8%84%91%E6%9C%BA%E6%8E%A5%E5%8F%A3%20%E5%85%A5%E9%97%A8%20EEG%20%E4%BF%A1%E5%8F%B7%E5%A4%84%E7%90%86",
        region: "入门",
        topic: "Video · BCI",
        keywords: ["脑机接口", "EEG", "信号处理", "中文视频"],
        importance: "medium",
        evidence: "video",
        result: "中文视频适合第一轮建立直觉：什么是 EEG、如何做预处理、常见 BCI 范式有哪些。",
        significance: "中文资料能降低入门门槛，但要优先选择高校课程、实验室讲座或有论文/代码配套的视频。",
        commentary: "不要被标题党带走，重点看是否讲清采集、滤波、特征、分类和实验范式。",
        impact: "看完后尝试复述一个 BCI pipeline：信号采集 -> 预处理 -> 解码 -> 反馈。"
      },
      {
        id: "bci-society-resources",
        title: "BCI Society Resources",
        source: "BCI Society",
        date: "Community",
        url: "https://bcisociety.org/",
        region: "入门",
        topic: "Community · BCI",
        keywords: ["BCI Society", "conference", "community", "workshop"],
        importance: "medium",
        evidence: "community",
        result: "BCI Society 是脑机接口社区入口，可追踪会议、研讨会、社区资源和研究方向。",
        significance: "入门阶段不仅要读论文，也要知道这个领域的人在哪里交流、哪些问题被反复讨论。",
        commentary: "适合用来找会议报告、workshop 和领域关键词。",
        impact: "帮助你从“单篇论文”转向“研究共同体”的视角。"
      },
      {
        id: "deep-rl-berkeley-cs285",
        title: "Berkeley CS285: Deep Reinforcement Learning",
        source: "UC Berkeley / YouTube",
        date: "Video",
        url: "https://www.youtube.com/results?search_query=Berkeley+CS285+Deep+Reinforcement+Learning",
        region: "入门",
        topic: "Video · 具身智能",
        keywords: ["deep reinforcement learning", "robot learning", "policy", "control"],
        importance: "high",
        evidence: "course",
        result: "用课程视频理解 policy、value、model-based RL、imitation learning 和 robot learning 的基础语言。",
        significance: "具身智能的很多论文都默认你理解强化学习和控制问题；这门课能补核心概念。",
        commentary: "建议先看 imitation learning、policy gradients 和 model-based RL。",
        impact: "能帮助你理解机器人为什么需要数据、仿真、奖励和策略泛化。"
      },
      {
        id: "stanford-cs223a-robotics",
        title: "Stanford CS223A: Introduction to Robotics",
        source: "Stanford / YouTube",
        date: "Video",
        url: "https://www.youtube.com/results?search_query=Stanford+CS223A+Introduction+to+Robotics",
        region: "入门",
        topic: "Video · 机器人",
        keywords: ["robotics", "kinematics", "control", "manipulation"],
        importance: "high",
        evidence: "course",
        result: "用机器人基础课补运动学、动力学、控制和机械臂操作的基本概念。",
        significance: "BCI 控制机器人或假肢时，输出不是抽象标签，而是要落到真实运动系统。",
        commentary: "先看坐标变换、运动学和控制，不必一开始啃所有推导。",
        impact: "能让你和机器人方向同学讨论 shared autonomy、机械臂控制和人机协同时不失语。"
      },
      {
        ...
        region: "入门",
        topic: "Paper · 具身智能",
        keywords: ["Open X-Embodiment", "robot data", "RT-X", "generalist robot policy"],
        importance: "critical",
        evidence: "paper",
        result: "汇集跨机器人数据并训练通用机器人策略，展示机器人领域从单任务走向数据规模化。",
        significance: "它解释了为什么具身智能现在这么关注数据集、跨平台泛化和基础模型。",
        commentary: "读重点：数据怎么统一、任务怎么定义、泛化如何评测。",
        impact: "对 BCI 也有启发：低带宽神经意图可以和高层机器人策略结合。"
      },
      {
        id: "embodied-ai-bilibili-search",
        title: "Bilibili: 具身智能 / 人形机器人 入门",
        source: "Bilibili 检索入口",
        date: "Video",
        url: "https://search.bilibili.com/all?keyword=%E5%85%B7%E8%BA%AB%E6%99%BA%E8%83%BD%20%E4%BA%BA%E5%BD%A2%E6%9C%BA%E5%99%A8%E4%BA%BA%20%E5%85%A5%E9%97%A8",
        region: "入门",
        topic: "Video · 具身智能",
        keywords: ["具身智能", "人形机器人", "VLA", "world model", "中文视频"],
        importance: "medium",
        evidence: "video",
        result: "中文视频适合快速了解具身智能、人形机器人、VLA 模型和世界模型这些热词。",
        significance: "它能帮你从产业和概念层面建立直觉，再回到英文论文和课程核验细节。",
        commentary: "优先看高校/研究机构报告、公司技术分享和带论文引用的视频。",
        impact: "看完后尝试总结：具身智能和传统机器人、纯 LLM 到底差在哪里。"
      }
    ]
  }
];
...
const uiText = {
  ...
  en: {
    export: "Export",
    heroEyebrow: "AI Daily · Chronicle · Learning",
    heroTitle: "AI Daily",
    metricToday: "Today",
    metricHigh: "High",
    ...
    cardLearn: "AI / BCI / Embodied path",
...
function renderPaperPath() {
  ...
  if (!papers.length) {
    els.paperPath.innerHTML = '<div class="empty">还没有入门学习路线。</div>';
    return;
  }
...
function collectChronicleItem(id) {
  ...
  const article = normalizeArticle({
    ...
    evidence: item.evidence || (item.region === "入门" ? "review" : /policy|capital|infrastructure/i.test(item.topic) ? "industry" : "review"),
